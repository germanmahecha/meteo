...
-->
<?php 
    require_once("Fonctions.php");//Fichier reference des fonctions
    ...
    $optionsPays=creerOptionsPaysSelected($tableauPays,$paysChoisi);
    ...
    {   
       $paysChoisi=$tableauPays[$_GET["formPays"]];// Afectacion de la variable $pays choisi avec le pays selectionné dans le formulaire
        ...
        if(isset($contenuVilles))//Validation si l'extraction des villes s'a fait correctement
        {
            ...
            {
                $villeChoisi="-";
                 $optionsVilles=creerOptionsVillesSelected($tableauVilles,$villeChoisi);//Options du select pays actualisés
